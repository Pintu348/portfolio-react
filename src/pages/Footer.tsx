    ...
    <footer className='w-full border-t border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur py-6 mt-12'>
      <div className='max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4'>
        ...
        <div className='flex gap-4'>
          {/* GitHub */}
          <a
            href='https://github.com/pintu348'
            target='_blank'
          ...
          {/* LinkedIn */}
          <a
            href='https://www.linkedin.com/in/pintu-pandit/'
            target='_blank'
            rel='noopener noreferrer'
            className='text-gray-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition'
            aria-label='LinkedIn'
          >
            <svg width='20' height='20' fill='currentColor' viewBox='0 0 24 24'>
              <path d='M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.3c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm13.5 11.3h-3v-5.5c0-1.38-.02-3.15-1.92-3.15-1.92 0-2.22 1.5-2.22 3.05v5.6h-3v-10h2.88v1.36h.04c.4-.75 1.38-1.54 2.84-1.54 3.03 0 3.59 1.99 3.59 4.58v5.6z' />
            </svg>
          </a>
        </div>
      </div>
